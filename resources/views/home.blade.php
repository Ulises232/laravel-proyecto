...
<main>
  <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
    <div class="col-md-5 p-lg-5 mx-auto my-5">
      <h1 class="display-4 fw-normal">BIENVENIDO ADMIN</h1>
      <p class="lead fw-normal">Registro de clientes, pedidos realizados, lista de libros disponibles y editoriales.</p>
      <a class="btn btn-outline-secondary" href="/clientes">Ver registros de clientes</a>
    </div>
  ...
  <div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
    <div class="bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
      <div class="my-3 py-3">
        <h2 class="display-5">Registro de editoriales</h2>
        <p class="lead">Puedes tener los detalles de cada editorial, actualizarlos y eliminarlos.</p>
        <a class="btn btn-outline-secondary" href="/editoriales/captura">Capturar nueva editorial</a>
      </div>
      <img class="bg-light shadow-sm mx-auto" style="width: 80%; height: 300px; border-radius: 21px 21px 0 0;" src="https://ep00.epimg.net/cultura/imagenes/2016/08/04/actualidad/1470334760_632356_1470336952_noticia_normal.jpg" alt="">
    </div>
    <div class="bg-light me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
      <div class="my-3 p-3">
        <h2 class="display-5">Registro de Libros</h2>
        <p class="lead">Ten el registro de los libros disponibles en un listado, junto con sus detalles.</p>
        <a class="btn btn-outline-secondary" href="/libros/captura">Capturar libros nuevos</a>
      </div>
      <img src="https://www.literautas.com/es/blog/wp-content/uploads/libros-para-el-2015.gif" class="bg-dark shadow-sm mx-auto" style="width: 80%; height: 300px; border-radius: 21px 21px 0 0;" alt="">
    </div>
  </div>
