...
<header class="site-header sticky-top py-1">
  ...
  <path fill-rule="evenodd" d="M7.293 1.5a1 1 0 0 1 1.414 0l6.647 6.646a.5.5 0 0 1-.708.708L8 2.207 1.354 8.854a.5.5 0 1 1-.708-.708L7.293 1.5z"/></svg>
    ...
    <a class="py-2 d-none d-md-inline-block" href="{{url('pedido/libro/'.Auth::user()->id)}}">Lista de pedidos</a>
...
<main>
  <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
    <div class="col-md-5 p-lg-5 mx-auto my-5">
      ...
      <p class="lead fw-normal">Consulta la lista de libros disponibles y realiza pedidos.</p>
      <a class="btn btn-outline-secondary" href="/libros">Consulta libros</a>
    </div>
  ...
  <div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
    <div class="bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
      <div class="my-3 py-3">
        ...
        <p class="lead">Ver el listado de libros disponibles y sus detalles.</p>
        <a class="btn btn-outline-secondary" href="/libros">Libros disponibles</a>
      </div>
      <img class="bg-light shadow-sm mx-auto" style="width: 80%; height: 300px; border-radius: 21px 21px 0 0;" src="https://www.literautas.com/es/blog/wp-content/uploads/libros-para-el-2015.gif" alt="">
    </div>
    <div class="bg-light me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
      <div class="my-3 p-3">
        <h2 class="display-5">Lista de Pedidos</h2>
        <p class="lead">Realiza pedidos de tus libros favoritos.</p>
        <a class="btn btn-outline-secondary" href="{{url('pedido/libro/'.Auth::user()->id)}}">Lista de pedido</a>
      </div>
