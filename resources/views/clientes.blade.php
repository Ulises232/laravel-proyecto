...
<div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
    <div class="col-md-5 p-lg-5 mx-auto my-5">
      ...
      <p class="lead fw-normal">Listado de los clientes.</p>
    </div>
        ...
        <div class="col-sm-4">
            <div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
                <div class="bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
                    <div class="my-3 py-3">
                    <h2>Nombre:</h2>
                    <h2 class="display-5">{{$cliente->nombre}}</h2>
                    <br>
                    <h2>Direccion:</h2>
                    <h2 class="display-5">{{$cliente->direccion}}</h2>
                    <br>
                    <h2>Saldo:</h2>
                    <h2 class="display-5">{{$cliente->saldo}}</h2>
                    <br>
                    <a type="button" class="btn btn-light" href="{{url('cliente/cambiar/'.$cliente->id)}}">Editar</a>
                    <td> <a type="button" class="btn btn-light" href="{{url('cliente/eliminar/'.$cliente->id)}}">Eliminar</a></td>
                    </div>
                </div>
