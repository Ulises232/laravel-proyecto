  ...
  <path fill-rule="evenodd" d="M7.293 1.5a1 1 0 0 1 1.414 0l6.647 6.646a.5.5 0 0 1-.708.708L8 2.207 1.354 8.854a.5.5 0 1 1-.708-.708L7.293 1.5z"/></svg>
    ...
    <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
        <div class="col-md-5 p-lg-5 mx-auto my-5">
          <h1 class="display-4 fw-normal">LISTA DE EDITORIALES</h1>
          <p class="lead fw-normal">Listado de editoriales disppnibles.</p>
        </div>
            ...
            <div class="col-sm-6">
                <div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
                    <div class="bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
                        <div class="my-3 py-3">
                        <h2 class="text-danger">NOMBRE:</h2>
                        <h2 class="display-5">{{$editorial->nombre}}</h2>
                        <a type="button" class="btn btn-light" href="{{url('editorial/'.$editorial->id)}}">Detalles</a>
                        <a type="button" class="btn btn-light" href="{{url('editorial/cambiar/'.$editorial->id)}}">Editar</a>
                        <td> <a type="button" class="btn btn-light" href="{{url('editorial/eliminar/'.$editorial->id)}}">Eliminar</a></td>
                        </div>
                    </div>
                </div>
            </div>
