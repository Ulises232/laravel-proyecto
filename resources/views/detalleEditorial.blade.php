...
<div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
    <div class="col-md-5 p-lg-5 mx-auto my-5">
      <h1 class="display-4 fw-normal">DETALLES DE LA EDITORIAL</h1>
      <p class="lead fw-normal">Detalles de la editorial seleccionada.</p>
    </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                    <div class="bg-dark text-center text-white overflow-hidden">
                        <div class="my-6 py-6">
                        <h2 class="display-5 text-danger">NOMBRE:</h2>
                        <br>
                        <h4>{{$editorial->nombre}}</h4>
                        <br>
                        <h2 class="display-5 text-danger">CONTACTO:</h2>
                        <br>
                        <h4>{{$editorial->contacto}}</h4>
                        <br>
                        <h2 class="display-5 text-danger">DIRECCIÓN:</h2>
                        <br>
                        <h4>{{$editorial->direccion}}</h4>
                        <br>
                        <h2 class="display-5 text-danger">TELEFONO:</h2>
                        <br>
                        <h4>{{$editorial->telefono}}</h4>
                        </div>
                    </div>
            </div>
...
<br>
<br>
<h1 class="text-center"s><a type="button" class="btn btn-outline-dark btn-lg " href="{{url('/editoriales')}}">Volver</a></h1>
