...
<div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
    <div class="col-md-5 p-lg-5 mx-auto my-5">
      <h1 class="display-4 fw-normal">DETALLES DEL CLIENTE</h1>
      <p class="lead fw-normal">Detalles del cliente seleccionado.</p>
    </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                    <div class="bg-dark text-center text-white overflow-hidden">
                        ...
                        <br>
                        <h2 class="display-5 text-danger">SALDO:</h2>
                        <br>
                        <h4>{{$cliente->saldo}}</h4>
                        </div>
                    </div>
...
<br>
<br>
<h1 class="text-center"s><a type="button" class="btn btn-outline-dark btn-lg " href="{{url('/clientes')}}">Volver</a></h1>
