            ...
            <div class="col-sm-6">
                <div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
                    <div class="bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
                        ...
                        <a type="button" class="btn btn-light" href="{{url('libro/cambiar/'.$libro->id)}}">Editar</a>
                        <td> <a type="button" class="btn btn-light" href="{{url('libro/eliminar/'.$libro->id)}}">Eliminar</a></td>
                        </div>
