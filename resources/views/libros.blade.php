...
<header class="site-header sticky-top py-1">
  ...
  <path fill-rule="evenodd" d="M7.293 1.5a1 1 0 0 1 1.414 0l6.647 6.646a.5.5 0 0 1-.708.708L8 2.207 1.354 8.854a.5.5 0 1 1-.708-.708L7.293 1.5z"/></svg>
    ...
    <a class="py-2 d-none d-md-inline-block" href="{{url('pedido/libro/'.Auth::user()->id)}}">Lista de pedido</a>
    ...
    <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
        <div class="col-md-5 p-lg-5 mx-auto my-5">
          <h1 class="display-4 fw-normal">LISTA DE LIBROS</h1>
          <p class="lead fw-normal">Encuentra una gran variedad de Libros.</p>
        </div>
            ...
            <div class="col-sm-6">
                <div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
                    <div class="bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
                        ...
                        <a type="button" class="btn btn-light" href="{{url('libro/'.$libro->id)}}">Detalles</a>
                        </div>
                        <img class="bg-light shadow-sm mx-auto" style="width: 80%; height: 300px; border-radius: 21px 21px 0 0;" src="{{asset('img/'.$libro->foto)}}" alt="">
                    </div>
                </div>
            </div>
