...
<form method="post" class="col-md-4 offset-md-4"action="{{url('/clientes/actualizar/'.$cliente->id)}}">
{{csrf_field()}}
<br>
<h1>Cambie los datos de un cliente</h1>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" value="{{$cliente->saldo}}"  id="saldo" name="saldo">
  </div>
  @endif
  <input type="submit" class="btn btn-dark" value="Actualizar Cliente"></input>
  <a type="button" class="btn btn-outline-dark btn-lg " href="{{url('/clientes')}}">Volver</a>
</form>
</body>
<br>
<br>
